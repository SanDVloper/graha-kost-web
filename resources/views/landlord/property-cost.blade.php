...
<body class="bg-[#f4f7f6] text-slate-800 min-h-screen flex flex-col pb-24">
    ...
    <main class="max-w-4xl mx-auto px-6 w-full flex-1">
        ...
        <div class="flex items-center justify-between mb-6 mt-4">
            <div>
                <h2 class="text-2xl font-bold text-[#1e3a5f]">Informasi Jenis Kamar</h2>
    ...
    <div class="room-entry relative" data-index="0">
        <div class="absolute right-0 top-0 mt-4 mr-4 z-10">
            <button type="button" class="remove-room-btn hidden text-red-500 hover:text-red-700 bg-red-50 px-4 py-2 rounded-lg font-bold text-sm border border-red-200 transition-colors"><i class="fa-solid fa-trash mr-1"></i> Hapus Kamar Ini</button>
        </div>
<!-- Card 1: Detail Kamar -->
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-8 relative overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="rooms[0][name]" class="w-full bg-[#f4f5f7] border border-transparent rounded-lg px-4 py-3 text-slate-700 focus:outline-none focus:border-[#38a38e] focus:bg-white transition-colors" placeholder="Misal: Standard Non-AC, Kamar VIP..." required>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            ...
                            <div class="relative">
                                <input type="text" name="rooms[0][size]" class="w-full bg-[#f4f5f7] border border-transparent rounded-lg px-4 py-3 pr-10 text-slate-700 focus:outline-none focus:border-[#38a38e] focus:bg-white transition-colors" placeholder="3 x 4" required>
                        ...
                        <div class="w-24">
                            ...
                            <input type="number" name="rooms[0][quantity]" class="w-full bg-[#f4f5f7] border border-transparent rounded-lg px-4 py-3 text-center text-slate-700 focus:outline-none focus:border-[#38a38e] focus:bg-white transition-colors" value="1" min="1" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 mt-2">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <!-- Array checkbox dengan name="rooms[0][facilities][]" -->
                            <label class="cursor-pointer room-facility">
                                <input type="checkbox" name="rooms[0][facilities][]" value="Kasur" class="sr-only peer hidden-checkbox">
                            ...
                            <label class="cursor-pointer room-facility">
                                <input type="checkbox" name="rooms[0][facilities][]" value="K. Mandi Dalam" class="sr-only peer hidden-checkbox">
                                <div class="facility-box rounded-xl border-2 border-transparent bg-[#f4f5f7] p-4 flex items-center transition-all peer-checked:border-[#38a38e] peer-checked:bg-teal-50">
                            ...
                            <label class="cursor-pointer room-facility">
                                <input type="checkbox" name="rooms[0][facilities][]" value="AC" class="sr-only peer hidden-checkbox">
                                <div class="facility-box rounded-xl border-2 border-transparent bg-[#f4f5f7] p-4 flex items-center transition-all peer-checked:border-[#38a38e] peer-checked:bg-teal-50">
                            ...
                            <label class="cursor-pointer room-facility">
                                <input type="checkbox" name="rooms[0][facilities][]" value="Lemari" class="sr-only peer hidden-checkbox">
                                <div class="facility-box rounded-xl border-2 border-transparent bg-[#f4f5f7] p-4 flex items-center transition-all peer-checked:border-[#38a38e] peer-checked:bg-teal-50">
                            ...
                            <label class="cursor-pointer room-facility">
                                <input type="checkbox" name="rooms[0][facilities][]" value="TV" class="sr-only peer hidden-checkbox">
                                <div class="facility-box rounded-xl border-2 border-transparent bg-[#f4f5f7] p-4 flex items-center transition-all peer-checked:border-[#38a38e] peer-checked:bg-teal-50">
                            ...
                            <label class="cursor-pointer room-facility">
                                <input type="checkbox" name="rooms[0][facilities][]" value="Water Heater" class="sr-only peer hidden-checkbox">
                                <div class="facility-box rounded-xl border-2 border-transparent bg-[#f4f5f7] p-4 flex items-center transition-all peer-checked:border-[#38a38e] peer-checked:bg-teal-50">
                ...
                <div class="space-y-4">
                    ...
                    <div class="price-row flex flex-col sm:flex-row sm:items-center justify-between p-5 border-2 border-[#38a38e] bg-teal-50/50 rounded-xl gap-4 transition-all">
                        ...
                        <div class="relative w-full sm:w-64">
                            ...
                            <input type="text" name="rooms[0][price_monthly]" class="price-input format-rp w-full bg-white border border-gray-300 rounded-lg py-3 pl-12 pr-12 text-right font-bold text-[#1e3a5f] focus:outline-none focus:border-[#38a38e] transition-colors" placeholder="0">
                    ...
                    <div class="price-row flex flex-col sm:flex-row sm:items-center justify-between p-5 border-2 border-transparent bg-[#f4f5f7] rounded-xl gap-4 transition-all">
                        ...
                        <div class="relative w-full sm:w-64 opacity-50 input-wrapper">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-bold text-sm">Rp</span>
                            <input type="text" name="rooms[0][price_daily]" class="price-input format-rp w-full bg-white border border-gray-300 rounded-lg py-3 pl-12 pr-12 text-right font-bold text-[#1e3a5f] focus:outline-none focus:border-[#38a38e] transition-colors" placeholder="0" disabled>
                    ...
                    <div class="price-row flex flex-col sm:flex-row sm:items-center justify-between p-5 border-2 border-transparent bg-[#f4f5f7] rounded-xl gap-4 transition-all">
                        ...
                        <div class="relative w-full sm:w-64 opacity-50 input-wrapper">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-bold text-sm">Rp</span>
                            <input type="text" name="rooms[0][price_yearly]" class="price-input format-rp w-full bg-white border border-gray-300 rounded-lg py-3 pl-12 pr-12 text-right font-bold text-[#1e3a5f] focus:outline-none focus:border-[#38a38e] transition-colors" placeholder="0" disabled>
...
<button type="button" id="add-room-btn" class="w-full py-4 border-2 border-dashed border-[#38a38e] text-[#38a38e] font-bold rounded-2xl hover:bg-teal-50 transition-colors mb-8 shadow-sm flex items-center justify-center text-lg">
    <i class="fa-solid fa-plus mr-3"></i> Tambah Jenis Kamar Lain
</button>
...
<!-- Card 3: Manajemen Tagihan Utilitas -->
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            // 5. Logika Tambah Jenis Kamar
            $('#add-room-btn').click(function() {
                let container = $('#rooms-container');
                let entries = container.find('.room-entry');
                let index = entries.length; // Index baru
                
                // Clone the first entry
                let newEntry = entries.first().clone();
                ...
                // Reset toggle disabled state
                newEntry.find('.price-toggle').prop('checked', false);
                newEntry.find('.price-input').prop('disabled', true).val('');
                newEntry.find('.input-wrapper').addClass('opacity-50');
                newEntry.find('.price-row').removeClass('border-[#38a38e] bg-teal-50/50').addClass('border-transparent bg-[#f4f5f7]');
                newEntry.find('.price-row label').removeClass('text-[#1e3a5f]').addClass('text-gray-500');
                
                // Reset facility icons
                newEntry.find('.icon-fac').removeClass('text-[#38a38e]').addClass('text-gray-400');
                newEntry.find('.text-fac').removeClass('text-[#38a38e]').addClass('text-gray-500');
                newEntry.find('.facility-box').removeClass('border-[#38a38e] bg-teal-50');
                
                // Show remove button
                newEntry.find('.remove-room-btn').removeClass('hidden');
                
                // Update names
                newEntry.find('input').each(function() {
                    let name = $(this).attr('name');
                    if (name && name.startsWith('rooms[0]')) {
                        $(this).attr('name', name.replace('rooms[0]', 'rooms[' + index + ']'));
                    }
                });
            ...
            function updateRoomLabels() {
                let entries = $('.room-entry');
                if(entries.length > 1) {
                    entries.find('.remove-room-btn').removeClass('hidden');
                    entries.first().find('.remove-room-btn').addClass('hidden'); // First cannot be removed
                } else {
                    entries.find('.remove-room-btn').addClass('hidden');
                }
                ...
                entries.each(function(idx) {
                    ...
                    $(this).find('input').each(function() {
                        let name = $(this).attr('name');
                        if (name && name.startsWith('rooms[')) {
                            $(this).attr('name', name.replace(/rooms\[\d+\]/, 'rooms[' + idx + ']'));
                        }
                    });
                });
            }
            ...
            $(document).on('change', '.room-facility input[type="checkbox"]', function() {
